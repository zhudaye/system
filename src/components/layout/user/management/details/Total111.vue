						...
						<ul v-show="ifcaizhi" class="f-mr-ul">
							...
							<li>
								<Select v-model="modelc" @on-change="caizhic" >
									<Option v-for="item in caizhi" :value="item.value"  :key="item.value">{{ item.label }}</Option>
								</Select>
							</li>
						</ul>			
						...
						<ul v-show="ifman" class="f-mr-ul">
							...
							<li>
								<div class="color" >
									...
									<b class="color1" @click="colorClicka(1)"  v-show=" colora.indexOf(1) !== -1 "  style="background-color: #fff;border:2px solid Lavender">
										<i style="background-color: #fff;"></i>
									</b>

									<b class="color2" @click="colorClicka(2)"  v-show=" colora.indexOf(2) !== -1 " style="background-color: #000;border:2px solid #000">
										<i  style="background-color: #000"></i>
									</b> 
									<b class="color2" @click="colorClicka(3)"  v-show=" colora.indexOf(3) !== -1 " style="background-color: #2b3a6d;border:2px solid #2b3a6d">
										<i  style="background-color: #2b3a6d"></i>
									</b> 
									<b class="color2 reds" @click="colorClicka(4)"  v-show=" colora.indexOf(4) !== -1 " style="background-color: #ff0000;border:2px solid #ff0000">
										<i  style="background-color: #ff0000"></i>
									</b> 
									<b class="color2" @click="colorClicka(5)"    v-show=" colora.indexOf(5) !== -1 " style="background-color: #eee;border:2px solid #eee">
...
export default{
	...
	mounted(){
		...
		for(var i in this.colors){
			let col;
			col = this.colors[i].color;
			this.colora.push(col);	
		};
		for(var i in this.colors){
			let col;
			col = this.colors[i].color;
			this.colorb.push(col);	
		};
		for(var i in this.colors){
			let col;
			col = this.colors[i].color;
			this.colorc.push(col);	
		};
