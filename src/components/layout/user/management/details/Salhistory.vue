    ...
    <Row>
      <Col span="24">
        <h2 style="color:#495060">
            <span class="name">{{name}}</span>&nbsp;&nbsp;的销售记录
        </h2>
      </Col>
    </Row>
...
export default {
  ...
  data() {
    return {
      ...
      users:[
            {id:'001',order:'123',time:'2018-1-22',nick:'hy',treasure:'10',number:'11',state:'已支付',type:'支付宝',money:'199' },
            {id:'002',order:'123',time:'2018-1-22',nick:'hy',treasure:'10',number:'11',state:'已支付',type:'支付宝',money:'199' },
            {id:'003',order:'123',time:'2018-1-22',nick:'hy',treasure:'10',number:'11',state:'已支付',type:'支付宝',money:'199' },
            {id:'004',order:'123',time:'2018-1-22',nick:'hy',treasure:'10',number:'11',state:'已支付',type:'支付宝',money:'199' },
            {id:'005',order:'123',time:'2018-1-22',nick:'hy',treasure:'10',number:'11',state:'已支付',type:'支付宝',money:'199' },
